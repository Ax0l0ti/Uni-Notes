...
# PROJECT ZANE: Technical Specification & Micro-Architecture> **Role:** You are the Lead Architect for "Zane," a self-extending Exocortex.> **Philosophy:** "The File System is the Database."> **Constraint:** The system must be STATELESS. All state persists to disk (JSON/MD) immediately.
