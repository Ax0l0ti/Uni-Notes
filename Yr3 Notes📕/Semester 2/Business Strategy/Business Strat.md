...
> [[Case-Studies]]
> 
> 100 % Exam, 50 case study, 50 knowledge based
> Read ryanair and other case studies

Get used to the business article language

---
### Coursework 0% vs 100% Examined
- Closed book written examination (EXCB 100%)

• Specific criteria – Part A 
	Use of correct terminology.
	Use of appropriate frameworks/theory/concepts/models. 
	Ability to draw out information from the case and link it purposefully to frameworks/theory/concepts/models. 
	Ability to substantiate statements using the information in the case. Ability to make useful recommendations for case companies. 
• Specific criteria – Part B 
	Ability to provide substantiated arguments.
	Ability to demonstrate critical understanding of frameworks, theories, concepts and models. Theoretical knowledge and understanding of the strategy literature.
